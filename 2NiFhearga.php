...
function loginForm() {
	echo '
    <div id="loginform">
    <form action="2NiFhearga.php" method="post">
...
if (isset ( $_GET ['logout'] )) {
	...
	session_destroy ();
	header ( "Location: 2NiFhearga.php" ); // Redirect the user
}
...
<head>
 ...
 <?php
  ...
  <a href="2NiFhearga.php">Main Chat</a>
  ...
  <a href="2Sullibhan.php">2 Sullibhan</a>
   ...
   <div id="chatbox">
        ...
        <div class="content" id="content">
         <?php
		if (file_exists ( "log4.html" ) && filesize ( "log4.html" ) > 0) {
			$handle = fopen ( "log4.html", "r" );
			$contents = fread ( $handle, filesize ( "log4.html" ) );
			fclose ( $handle );
   ...
   <footer>
    <form action="2NiFhearga.php" autocomplete="off" method="post">
