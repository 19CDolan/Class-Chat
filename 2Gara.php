...
function loginForm() {
	echo '
    <div id="loginform">
    <form action="2Gara.php" method="post">
...
if (isset ( $_GET ['logout'] )) {
	...
	session_destroy ();
	header ( "Location: 2Gara.php" ); // Redirect the user
}
  ...
  <a href="2Sullibhan.php">2 Sullibhan</a>
   ...
   <div id="chatbox">
        ...
        <div class="content" id="content">
         <?php
		if (file_exists ( "log3.html" ) && filesize ( "log3.html" ) > 0) {
			$handle = fopen ( "log3.html", "r" );
			$contents = fread ( $handle, filesize ( "log3.html" ) );
			fclose ( $handle );
   ...
   <footer>
    <form action="2Gara.php" autocomplete="off" method="post">
