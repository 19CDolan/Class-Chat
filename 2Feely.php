...
function loginForm() {
	echo '
    <div id="loginform">
    <form action="2Feely.php" method="post">
...
if (isset ( $_GET ['logout'] )) {
	...
	session_destroy ();
	header ( "Location: 2Feely.php" ); // Redirect the user
}
  ...
  <a href="2Sullibhan.php">2 Sullibhan</a>
   ...
   <div id="chatbox">
		...
		if (file_exists ( "log2.html" ) && filesize ( "log2.html" ) > 0) {
			$handle = fopen ( "log2.html", "r" );
			$contents = fread ( $handle, filesize ( "log2.html" ) );
			fclose ( $handle );
   ...
   <footer>
    <form action="2Feely.php" autocomplete="off" method="post">
